...
export async function generateMetadata({ params }) {
    const t = await getTranslations('SurgerieItemPage1');
    const surgeriesPort =
      surgeriesItems.filter((elm) => elm.url === params.id)[0] || surgeriesItems[0];
  
    return {
      title: `${t(`${surgeriesPort.url}.title`)} || Dr. Thomas Benson`,
      description: t(`${surgeriesPort.url}.descr`) || "Conheça as cirurgias realizadas pelo Dr. Thomas Benson.",
    };
  }
...
export default function SurgerieItemPage1({ params }) {
    const t = useTranslations('SurgerieItemPage1');
    const surgeriesPort =
    surgeriesItems.filter((elm) => elm.url == params.id)[0] || surgeriesItems[0];

    const translatedTitle = t(`${surgeriesPort.url}.title`);
    const translatedDescr = t(`${surgeriesPort.url}.descr`);
    const translatedContent = t.raw(`${surgeriesPort.url}.content`);
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-8 offset-md-2">
                        ...
                        <h1 className="hs-title-1 mb-20">
                          ...
                          >
                            <AnimatedText text={translatedTitle} />
                          </span>
                        </h1>
                        <div className="row">
